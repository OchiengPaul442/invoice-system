...
function ModernPreview(): JSX.Element {
  return (
    <div className="h-full rounded-xl bg-white shadow-sm ring-1 ring-slate-200">
      <div className="rounded-t-xl bg-slate-900 px-4 py-3 text-slate-200">
        <div className="flex items-start justify-between">
          <div>
            <p className="text-[8px] uppercase tracking-[0.2em] text-slate-400">
              Invoice
            </p>
            <p className="mt-1 text-sm font-bold text-white">INV-2026-019</p>
          </div>
          <div className="text-right text-[9px]">
            <p>Issued: Mar 16, 2026</p>
            <p>Due: Apr 16, 2026</p>
          </div>
        </div>
        <p className="mt-1 text-[9px] text-slate-300">
          LedgerBloom Studio · bill@ledgerbloom.com
        </p>
      </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="rounded border border-slate-200 p-2">
            ...
            <p className="font-semibold text-slate-900">
              Mombasa Creative Agency
            </p>
            <p className="text-[9px]">finance@mca.co.ke</p>
          </div>
          <div className="rounded border border-slate-200 p-2">
            <p className="text-[8px] uppercase tracking-wide text-slate-400">
              Project
            </p>
            <p className="font-semibold text-slate-900">Brand Refresh</p>
            <p className="text-[9px]">Q2 deliverables</p>
          </div>
        </div>
        <div className="mt-2 space-y-1">
          {sampleLineItems.map((item) => (
    ...
    <div className="h-full rounded-xl bg-white p-4 text-[10px] text-slate-700 shadow-sm ring-1 ring-slate-200">
      ...
      <div className="grid grid-cols-2 gap-2">
        <div>
          ...
          <p className="font-semibold text-slate-900">Kampala Tech Ltd</p>
          <p className="text-[9px]">accounts@kampalatech.com</p>
        </div>
        <div className="text-right">
          <p className="text-[8px] uppercase tracking-wide text-slate-400">
            From
          </p>
          <p className="font-semibold text-slate-900">LedgerBloom Studio</p>
          <p className="text-[9px]">bill@ledgerbloom.com</p>
        </div>
      </div>
      <div className="mt-3 space-y-1">
        {sampleLineItems.map((item) => (
          <div
            key={item.description}
            className="grid grid-cols-[1fr_auto] gap-2 border-b border-slate-200 pb-1"
          >
            <span>{item.description}</span>
            <span className="font-medium text-slate-900">
              {formatCurrency(item.amount, "USD")}
  ...
  return (
    <div className="h-full rounded-xl bg-white p-4 text-[10px] text-slate-700 shadow-sm ring-1 ring-slate-200">
      <div className="rounded bg-emerald-700 px-3 py-2 text-white">
        <p className="text-[9px] uppercase tracking-[0.16em] text-emerald-100">
          Monthly retainer
        </p>
    ...
    >
      <div className={cn("mx-auto", expanded ? "max-w-3xl" : "max-w-[420px]")}>
        <div
          className={cn(
            "mx-auto",
            expanded ? "aspect-[1.414/1]" : "aspect-[1.35/1]",
          )}
        >
